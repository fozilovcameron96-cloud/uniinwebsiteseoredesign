...
export const L: Record<Lang, Translation> = {
  en: {
    ...
    how1t: "Tell us about yourself", how1d: "A 2-minute conversation with Aria, our AI advisor. She asks the right questions about your budget, level and goals.",
  ...
  ru: {
    ...
    how1t: "Расскажите о себе", how1d: "2-минутный разговор с Арией — нашим ИИ-консультантом. Она задаёт правильные вопросы о вашем бюджете, уровне и целях.",
  ...
  uz: {
    ...
    how1t: "O'zingiz haqingizda ayting", how1d: "Aria, sun'iy intellekt maslahatchimiz bilan 2 daqiqalik suhbat. U byudjetingiz, darajangiz va maqsadlaringiz haqida to'g'ri savollarni beradi.",
